...
public class GameSequenceMemory : MonoBehaviour, ICountableLevelMinigame, IFinishableGame
{
    ...
    public void FinishGameAndDisplayResult()
    {
        ...
        RewardScreenManager.instance.EnableRewardScreen(points, _currentLevel);
